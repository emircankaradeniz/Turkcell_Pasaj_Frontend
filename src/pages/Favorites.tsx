...
export default function Favoriler() {
  ...
  return (
    <div className="flex max-w-[1400px] mx-auto mt-6 gap-6 p-4">
      {/* Sol Menü */}
      <div className="w-64 bg-white rounded-lg shadow-sm border p-4 text-gray-700 text-sm">
        <ul className="space-y-4">
          ...
          <Link to={"/hesap"} className="flex items-center gap-2 cursor-pointer hover:text-blue-600">
          ...
          {filtrelenmisFavoriler.length === 0 ? (
            ...
            filtrelenmisFavoriler.map((urun: Urun) => (
              ...
              >
                ...
                {/* Ürün Adı */}
                <div className="px-4 mt-3 font-medium text-sm text-gray-800">
                  {urun.ad}
                </div>
                ...
                <div className="px-4 pb-4 mt-2">
                  ...
                  <div className="text-gray-500 text-xs">
                    {Math.round(urun.fiyat / 3).toLocaleString("tr-TR")}₺ x 3 Ay
                  </div>
                </div>
              </div>
            ))
